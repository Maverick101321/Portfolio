        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
          <div className="flex items-center gap-x-12">
            <Link
              href="/"
              className={cn(
                "text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-500 to-purple-600 dark:from-violet-400 dark:to-purple-500 transition-all",
                hoveredNav ? "blur-sm opacity-60" : "opacity-100"
              )}
            >
              Varun Choudhary
            </Link>
          ...
          <div className="flex items-center gap-x-2 md:gap-x-4">
            <div className={cn(
              "hidden md:flex space-x-2 transition-all",
              hoveredNav ? "blur-sm opacity-60" : "opacity-100"
            )}>
